...
import static ch.epfl.sweng.evento.InfinitePagerAdapter.internal.Constants.PAGE_COUNT;
import ch.epfl.sweng.evento.InfinitePagerAdapter.internal.PageModel;

/**
 * Base class providing the adapter to populate inside of a {@link ch.epfl.sweng.evento.InfinitePagerAdapter.InfiniteViewPager}.
 ...
 * <ul>
 *     <li>{@link ch.epfl.sweng.evento.InfinitePagerAdapter.InfinitePagerAdapter#instantiateItem(Object)}</li>
