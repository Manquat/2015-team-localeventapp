...
public class Event implements ClusterItem {
    ...
    /**
     * Standard conversion from a Bitmap to a base64 String
    ...
    /**
     * Adapts a Calendar into a standard format String
     * @param calendar the Calendar to format
     * @return a String in a numeric-only format
     */
    ...
    /**
     * To be used when an image can't be gotten from an Event
      * @return a base64-encoded String representing a random testing image
     */
    ...
    /**
     * Adds a participant to the Event if the maximum number of participants allows it
     *
     * @param participant the User to be added to the list of participants
     * @return whether or not the user has been added to the list
     */
    ...
    /**
     * gets the set of all Users attending the Event
     * @return
     */
     ...
     * @return whether or not the User has been indeed removed
     */
    ...
    /**
     * creates a Bitmap image from a base64-encoded String
     * @param encodedString the base64-encoded String to be converted
    ...
    /**
     * Gets the starting date of the Event as a String in the format yyyy-MM-dd'T'HH:mm:ss'Z
     * @return
     */
